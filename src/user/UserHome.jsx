...
const skillsData = ['Stress', 'Depression', 'Anxiety', 'Sleeping Problem', 'Feeling Low', "Tired", 'Sick', 'Viral','Others'];
        ...
        <>
            ...
            <div style={homeStyle}>
                <div style={contentStyle}>
                    <div style={headingStyle}>⚡⚡Hi,how can I help you!!</div>
                    <div style={mainboxStyle}>
                        <div style={{ padding: '10px 20px', textAlign: 'left' }}>
                            <div style={{ display: 'flex' }}>
                                ...
                                <h3 style={{ fontWeight: 500 }}>Type your problem</h3>
                            </div>
